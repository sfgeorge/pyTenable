...
class DevianceAPI(APIEndpoint):
    ...
    def list(self,
        ...
        Examples:
            ...
            >>> for deviance in tad.deviances.list(
            ...     infrastructure_id='1',
            ...     dashboard_id='1',
            ...     resolved=True,
    ...
    def list_by_directory_and_checker(self,
        ...
        Examples:
            >>> for deviance in tad.deviances.list_by_directory_and_checker(
            ...     profile_id='1',
            ...     infrastructure_id='1',
            ...     dashboard_id='1',
            ...     checker_id='1',
    ...
    def list_by_checker(self,
        ...
        Examples:
            ...
            >>> for deviance in tad.deviances.list_by_checker(
            ...     profile_id='1',
            ...     checker_id='1',
            ...     expression={'OR': [{
    ...
    def update_by_checker(self,
        ...
        Example:
            >>> tad.deviances.update_by_checker(
            ...     profile_id='1',
            ...     checker_id='1',
            ...     ignore_until='2022-01-27T23:59:59.999Z'
            ...     )
    ...
    def search(self,
        ...
        Example:
            >>> for deviance in tad.deviances.search(
            ...     profile_id='1',
            ...     checker_id='1',
            ...     ad_object_id='1',
            ...     show_ignored=True,
